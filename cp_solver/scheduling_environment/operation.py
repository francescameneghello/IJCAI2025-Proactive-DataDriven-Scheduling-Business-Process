...
class Operation:
    ...
    def simulation_parameters(self):
        ...
        return self._simulation_parameters, self._activity

    def set_simulation_parameters(self, machine, mean, std, activity=None) -> None:
        """Add a list of predecessor operations to the current operation."""
        self._activity.append(activity)
        self._simulation_parameters[machine] = [mean, std]
